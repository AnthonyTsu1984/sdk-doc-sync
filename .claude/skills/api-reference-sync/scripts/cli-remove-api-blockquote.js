 ...
 *
 * Usage:
 *   node .claude/skills/api-reference-sync/scripts/cli-remove-api-blockquote.js --dry-run
 *   node .claude/skills/api-reference-sync/scripts/cli-remove-api-blockquote.js
 */
