 ...
 *
 * Usage:
 *   node .claude/skills/api-reference-sync/bin/export-doc.js <doc-token-or-url> [output-file]
 *
 * Example:
 *   node .claude/skills/api-reference-sync/bin/export-doc.js PR2adhLOKo3qCtxug65cKieMnUM ./output.md
 */
...
async function main() {
    ...
    if (!rawInput) {
        console.error('Usage: node .claude/skills/api-reference-sync/bin/export-doc.js <doc-token-or-url> [output-file]');
        process.exit(1);
    }
