 ...
 *
 * Usage:
 *   node .claude/skills/api-reference-sync/scripts/cli-v01-update.js --step=N [--dry-run] [--resource=Name] [--method=name]
 *
 * Steps:
...
if (!ONLY_STEP) {
    console.error('Usage: node .claude/skills/api-reference-sync/scripts/cli-v01-update.js --step=N [--dry-run] [--resource=Name] [--method=name]');
    process.exit(1);
}
