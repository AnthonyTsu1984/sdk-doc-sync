...
| Milvus REST API | `repos/milvus/internal/distributed/proxy/httpserver` plus `.claude/skills/api-reference-sync/specs/openapi-milvus.json` |
...
| Zilliz Cloud REST API | `repos/zilliz-cloud/vdc/global/cloud-control-api/src/main/java/com/zilliz/cloud/control/api/controller` plus `.claude/skills/api-reference-sync/specs/openapi-cloud.json` |
...
- Go: `.claude/skills/api-reference-sync/sdk-go.md`
- Node.js: `.claude/skills/api-reference-sync/sdk-node.md`
- C++: `.claude/skills/api-reference-sync/sdk-cpp.md`
- REST/OpenAPI: `.claude/skills/api-reference-sync/sdk-rest.md`
- Zilliz CLI: `.claude/skills/api-reference-sync/sdk-zilliz-cli.md`
- SDK alignment: `.claude/skills/api-reference-sync/sdk-alignment.md`
...
```bash
node .claude/skills/api-reference-sync/scripts/feishu-doc.js get-blocks <doc-token>
```
