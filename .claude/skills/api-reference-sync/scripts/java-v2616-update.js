 ...
 *
 * Usage:
 *   node .claude/skills/api-reference-sync/scripts/java-v2616-update.js --step=1 [--dry-run]
 *
 * Steps:
...
if (!ONLY_STEP) {
    console.error('Usage: node .claude/skills/api-reference-sync/scripts/java-v2616-update.js --step=N [--dry-run]');
    process.exit(1);
}
