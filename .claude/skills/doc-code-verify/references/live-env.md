...
```bash
node .claude/skills/doc-code-verify/scripts/verify-feishu-doc-code.js --doc <doc> --request-live
```
...
```bash
node .claude/skills/doc-code-verify/scripts/verify-feishu-doc-code.js --doc <doc> --live --allow-run
```

For generated scenario runtime, use:

```bash
node .claude/skills/doc-code-verify/scripts/verify-feishu-doc-code.js --doc <doc> --run-scenarios --live --allow-run --languages python,go,java,node,bash
```
