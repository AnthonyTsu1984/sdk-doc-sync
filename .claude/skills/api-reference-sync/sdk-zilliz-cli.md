...
Storage-integration docs are handled by `.claude/skills/api-reference-sync/scripts/zilliz-cli-v14x/update-v144-v145.js`. Run dry-run first; the script also updates related records' `Last Modified At` and deprecates removed `completion` behavior.
