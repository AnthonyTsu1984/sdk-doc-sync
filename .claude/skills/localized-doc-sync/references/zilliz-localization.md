...
- Translator entrypoint: `.claude/skills/api-reference-sync/bin/feishu-doc-translator.js`
- Orchestrator: `.claude/skills/api-reference-sync/src/feishu-doc-translator/index.js`
- Bitable reader: `.claude/skills/api-reference-sync/src/feishu-doc-translator/bitable-reader.js`
- Diff engine: `.claude/skills/api-reference-sync/src/feishu-doc-translator/translation-diff.js`
- Markdown translator: `.claude/skills/api-reference-sync/src/feishu-doc-translator/doc-translator.js`
- Feishu to Markdown: `.claude/skills/api-reference-sync/src/feishu-to-markdown.js`
- Markdown to Feishu: `.claude/skills/api-reference-sync/src/markdown-to-feishu.js`
- Bitable writer: `.claude/skills/api-reference-sync/src/sdk-doc-sync/bitable-writer.js`
- Low-level docs library: `.claude/skills/api-reference-sync/lib/lark-docs/`
