...
```bash
node .claude/skills/doc-code-verify/scripts/verify-feishu-doc-code.js --doc <doc> --scenario --languages python
```
...
```bash
node .claude/skills/doc-code-verify/scripts/verify-feishu-doc-code.js --doc <doc> --scenario --languages node
```
...
```bash
node .claude/skills/doc-code-verify/scripts/verify-feishu-doc-code.js --doc <doc> --scenario --languages bash
```
...
```bash
node .claude/skills/doc-code-verify/scripts/verify-feishu-doc-code.js --doc <doc> --scenario --languages go
```
...
```bash
node .claude/skills/doc-code-verify/scripts/verify-feishu-doc-code.js --doc <doc> --scenario --languages java
```
