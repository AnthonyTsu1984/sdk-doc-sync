 ...
 *
 * Usage:
 *   node .claude/skills/api-reference-sync/scripts/cli-v01-create.js --step=N [--dry-run] [--method=name] [--category=name] [--resource=name]
 *
 * Steps:
...
if (!ONLY_STEP) {
    console.error('Usage: node .claude/skills/api-reference-sync/scripts/cli-v01-create.js --step=N [--dry-run] [--method=name] [--category=name] [--resource=name]');
    process.exit(1);
}
