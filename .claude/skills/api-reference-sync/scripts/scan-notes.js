...
require('dotenv').config({ path: path.resolve('/Volumes/CaseSensitive/projects/feishu-markdown-bridge/.claude/skills/api-reference-sync', '.env') });

const FEISHU_HOST = process.env.FEISHU_HOST || 'https://open.feishu.cn';
const fetch = require('node-fetch');

async function getToken() {
  const larkTokenFetcher = require(path.resolve('/Volumes/CaseSensitive/projects/feishu-markdown-bridge/.claude/skills/api-reference-sync', 'lib/lark-docs/larkTokenFetcher'));
