...
node --test .claude/skills/api-reference-sync/tests/sdk-doc-sync-cli.test.js
node --test .claude/skills/api-reference-sync/tests/sdk-renderers.test.js .claude/skills/api-reference-sync/tests/cli-rest-renderers.test.js
node --test .claude/skills/api-reference-sync/tests/lark-doc-writer.test.js .claude/skills/api-reference-sync/tests/markdown-to-feishu-lists.test.js
```

Release-scope harness checks:

```bash
node --test .claude/skills/api-reference-sync/tests/release-scope.test.js
node --test .claude/skills/api-reference-sync/tests/release-scout-cli.test.js
node --test .claude/skills/api-reference-sync/tests/agent-harness.test.js
```
