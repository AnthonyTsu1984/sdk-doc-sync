...
Use `--sdk-reference <file>` only when testing or when the run must use a reviewed reference file outside the default `.claude/skills/api-reference-sync/sdk-<language>.md` location.
