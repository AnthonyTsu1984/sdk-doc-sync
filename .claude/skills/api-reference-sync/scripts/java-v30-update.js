...
async function phase4() {
    ...
    console.log(`    node .claude/skills/api-reference-sync/scripts/add-type-links.js --bitable ${BITABLE_TOKEN} --dry-run`);
    console.log(`    node .claude/skills/api-reference-sync/scripts/fix-leading-spaces.js --bitable ${BITABLE_TOKEN} --dry-run`);
    console.log(`    node .claude/skills/api-reference-sync/scripts/post-fix-links.js --bitable ${BITABLE_TOKEN} --dry-run`);
}
