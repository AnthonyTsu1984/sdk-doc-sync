...
Storage-integration docs are handled by ~~`.claude/skills/api-reference-sync/scripts/zilliz-cli-v14x/update-v144-v145.js`~~. Run dry-run first; the script also updates related records' `Last Modified At` and deprecates removed `completion` behavior. — *(removed 2026-09-26, phase-6 wave-1 disposition; canonical path: bin/sdk-doc-sync.js)*
...
node .claude/skills/api-reference-sync/bin/sdk-doc-sync.js --language zilliz-cli --sdk-dir repos/zilliz-cloud/vdc/zilliz-cli --sdk-version v0.1.x --dry-run
