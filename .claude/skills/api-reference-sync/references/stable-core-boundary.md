...
|---|---|---|
| Stable core | Release-independent schemas, adapters, renderers, validators, converters, and operational safety logic | Commit under `.claude/skills/api-reference-sync/src/` or `bin/` with focused tests |
